...
class Chinese extends StatefulWidget {
  ...
  @override
  State<Chinese> createState() => _HomePageState();
}

class _HomePageState extends State<Chinese> {
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("Chinese Recipes",style: TextStyle(fontSize: 20),)),
