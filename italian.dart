...
class Italian extends StatefulWidget {
  ...
  @override
  State<Italian> createState() => _HomePageState();
}

class _HomePageState extends State<Italian> {
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("Italian Recipes",style: TextStyle(fontSize: 20),)),
