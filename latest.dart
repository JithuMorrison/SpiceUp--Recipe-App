...
class Latest extends StatefulWidget {
  ...
  @override
  State<Latest> createState() => _HomePageState();
}

class _HomePageState extends State<Latest> {
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("Latest Recipes",style: TextStyle(fontSize: 20),)),
