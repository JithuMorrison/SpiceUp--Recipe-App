...
class _HomePageState extends State<History> {
  ...
  getApiData()async{
    response = await DatabaseHelper.instance.queryHist();
    print(response);
    response.forEach((e){
      Model model = Model(
        url: e['url'],
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("History",style: TextStyle(fontSize: 20),)),
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(child: ElevatedButton(onPressed: (){
                                      ...
                                      Future<int> sp = DatabaseHelper.instance.deleteHist(op);
                                      print(sp);
                                    },style: ElevatedButton.styleFrom(backgroundColor: Colors.grey[600]), child: const Text("Remove",style: TextStyle(color: Colors.white),),)),
                                  ),
                                ]
                            ),
                          ),
