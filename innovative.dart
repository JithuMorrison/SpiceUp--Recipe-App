...
class Innovative extends StatefulWidget {
  const Innovative({super.key});

  @override
  State<Innovative> createState() => _HomePageState();
}

class _HomePageState extends State<Innovative> {
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("Innovative Recipes",style: TextStyle(fontSize: 20),)),
