...
class Mexican extends StatefulWidget {
  ...
  @override
  State<Mexican> createState() => _HomePageState();
}

class _HomePageState extends State<Mexican> {
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [const Center(child: Text("Mexican Recipes",style: TextStyle(fontSize: 20),)),
